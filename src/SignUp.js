        ...
        <div className="wrap">
            ...
            <form className="form text-center" onSubmit={this.handleSubmit}>
              ...
              <div className="form-group">
                ...
                <input className="form-control" type="text" name="phone" value={this.state.phone} placeholder="Telephone" onChange={this.handleChange} />
              </div>
              <div className="form-group">
                <span className="text-danger">*</span>
                <input className="form-control" type="password" name="password" value={this.state.password} placeholder="Password" onChange={this.handleChange} minLength="6"/>
              </div>
              <div className="form-group">
                <input className="form-control" type="text" name="yearOfExperience" value={this.state.yearOfExperience} placeholder="Years of Experience" onChange={this.handleChange} />
              </div>
              <div className="form-group">
                <span className="text-danger">*</span>
                <input className="form-control" type="text" name="school" value={this.state.school} placeholder="University/Polytechnic/other" onChange={this.handleChange} />
              </div>
              <div className="form-group">
                <input className="form-control" type="text" name="levelOfEducation" value={this.state.levelOfEducation} placeholder="Your school" onChange={this.handleChange} placeholder="Highest Educational Qualification" />
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                <span className="text-danger">*</span>
                <input className="form-control" type="date" name="dateOfBirth" value={this.state.dateOfBirth} placeholder="Date of Birth" onChange={this.handleChange} />
              </div>
