  ...
  let navbar = (
    <div className='nav_flex'>
      ...
      <div className='spanlink'>
        <NavLink className="nav_link" activeClassName='current' to="/aboutus">About</NavLink>
        <NavLink className="nav_link" activeClassName='current' to="/contactus">Contact</NavLink>
  ...
  if (props.isLoggedIn) {
    navbar = (
      <div className='nav_flex'>
        ...
        <NavLink className="nav_link" activeClassName='current' to="/test">{props.takeTest ? <Icon classType="fas fa-chalkboard-teacher" /> : null} {props.takeTest}</NavLink>
